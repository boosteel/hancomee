import {_date, _dateFormat} from "./_func/datetime";
...
export class Calendar {
    ...
    format(str?: string) {
        ...
        return _dateFormat(this.value, str);
    }
    ...
    toString() {
        return _dateFormat(this.value, 'yyyy-MM-dd HH:mm:ss');
    }
...
export namespace Calendar {
    ...
    function today(str: string = 'yyyy-MM-dd') {
        return _dateFormat(new Date(), str);
    }
