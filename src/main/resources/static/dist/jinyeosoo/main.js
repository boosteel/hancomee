...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(15), __webpack_require__(11), __webpack_require__(0), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, NameMap_1, arrays_1, core_1, access_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(11)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, arrays_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(6), __webpack_require__(16), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, html_1, calendar_1, StringBuffer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var htmlParser = html_1.HTML.htmlParser;
    var _a = htmlParser(__webpack_require__(32)), $temp = _a[0], _b = _a[1], td = _b.td, year = _b.year, month = _b.month;
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(20), __webpack_require__(17), __webpack_require__(30), __webpack_require__(6), __webpack_require__(19), __webpack_require__(14), __webpack_require__(16), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1, _data_1, SelectCalendar_1, html_1, Forms_1, events_1, calendar_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function default_1(init) {
        return /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'account', init) || this;
            }
            C.prototype.$init = function (ele) {
                var _this = this;
                selectAll(ele, ['tbody', '!.modify', '.list', '.add'], function (e, tbody, modify, list, addBtn) {
                    var $customer, $values, $modify = -1, $form = selectAll(modify, ['.date-table', '[name="date"]'], function (e, table, input) {
                        // 달력 만들기
                        var cal = new SelectCalendar_1.SelectCalendar(new Date())
                            .appendTo(table);
                        cal.onSelect = function (v) { return input.value = v; };
                        return new Forms_1.Forms(modify);
                    }), $create = function (account) {
                        return selectAll(list.cloneNode(true), ['{data-name}'], function (l, map) {
                            var id = account.id, ctrl = {
                                // 수정화면
                                modify: function () {
                                    $form.reset(account);
                                ...
                                // account 삭제
                                remove: function () {
                                    _data_1.Account.remove(account.customer_id, account.id).then(function () {
                                        tbody.removeChild(l);
                                    });
                                }
                            };
                        ...
                        // ★★★ 데이터 추가, 수정
                        confirm: function () {
                            var values = $form.values(), v = new _data_1.Account(values).setCustomer($customer);
                            if ($modify !== -1)
                                v.id = $modify;
                            _data_1.Account.save(v).then(function (id) {
                                v.id = id;
                                if ($modify === -1)
                                    $create(v);
                                else
                                    $values[$modify].reset(v);
                                ctrl.cancel();
                            });
                        }
                    };
                    ...
                    addBtn.addEventListener('click', function () {
                        ...
                        tbody.insertBefore($form.reset({ date: calendar_1.Calendar.isodate(new Date()) }).element, tbody.firstChild);
                    });
                    propertyMap(tbody, 'click', ctrl);
                    // $load 초기화
                    _this.$load = function (customer, element) {
                        $values = {};
                        $modify = -1;
                        $customer = customer;
                        return _data_1.Account.list(customer.id).then(function (values) {
                            tbody.textContent = '';
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(20), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_1(init) {
        return /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'gallery', init) || this;
            }
            C.prototype.$init = function (ele) {
            };
            C.prototype.$load = function (customer, element) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(20), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1) {
    ...
    function default_1(init) {
        return /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'main', init) || this;
            }
            C.prototype.$init = function (ele) {
            };
            C.prototype.$load = function (customer, element) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(20), __webpack_require__(17), __webpack_require__(30), __webpack_require__(19), __webpack_require__(6), __webpack_require__(14), __webpack_require__(16), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1, _data_1, SelectCalendar_1, Forms_1, html_1, events_1, calendar_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var selectAll = html_1.HTML.selectAll;
    var propertyMap = events_1.Events.propertyMap;
    function default_1(init) {
        return /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'managing', init) || this;
            }
            C.prototype.$init = function (ele) {
                var _this = this;
                selectAll(ele, ['tbody', '!.modify', '.list', '.add'], function (e, tbody, modify, list, addBtn) {
                    var $customer, $values, $modify = -1, $form = selectAll(modify, ['.date-table', '[name="date"]'], function (e, table, input) {
                        ...
                        return selectAll(list.cloneNode(true), ['{data-name}'], function (l, map) {
                            var id = account.id, ctrl = {
                                ...
                                // account 삭제
                                remove: function () {
                                    _data_1.Managing.remove(account.id).then(function () {
                                        tbody.removeChild(l);
                                    });
                                }
                            };
                        ...
                        // ★★★ 데이터 추가, 수정
                        confirm: function () {
                            var values = $form.values(), v = new _data_1.Managing(values).setCustomer($customer);
                            if ($modify !== -1)
                                v.id = $modify;
                            _data_1.Managing.save(v).then(function (id) {
                                v.id = id;
                                if ($modify === -1)
                                    $create(v);
                                else
                    ...
                    _this.$load = function (customer, element) {
                        ...
                        $modify = -1;
                        $customer = customer;
                        return _data_1.Managing.list(customer.id).then(function (values) {
                            tbody.textContent = '';
                            values.forEach($create);
                        });
                    };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, spa_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_1(init) {
        return /** @class */ (function () {
            function Cal() {
                this._resolve = Promise.all([
                    spa_1.SPA.getFragment("jinyeosoo/root/intro"),
                    spa_1.SPA.getStyle("/dist/jinyeosoo/root/intro.css")
                ]).then(function (_a) {
                    var frag = _a[0], style = _a[1];
                    var element = frag.children[0];
                    element.insertBefore(style, element.firstChild);
            ...
            Cal.prototype.getParam = function () {
                return {};
            };
            Cal.prototype.init = function () {
                return this._resolve;
            };
            Cal.prototype.load = function (param, search) {
            };
            Cal.prototype.close = function () {
            };
            return Cal;
        }());
    }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, spa_1) {
    ...
    function default_1(init) {
        return /** @class */ (function () {
            function Cal() {
                this._resolve = Promise.all([
                    spa_1.SPA.getFragment("jinyeosoo/root/calendar"),
                    spa_1.SPA.getStyle("/dist/jinyeosoo/root/cal.css")
                ]).then(function (_a) {
                    var frag = _a[0], style = _a[1];
                    var element = frag.children[0];
                    element.insertBefore(style, element.firstChild);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(17), __webpack_require__(29), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, spa_1, _data_1, _form_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_1(init) {
        return /** @class */ (function () {
            function Register() {
                this.onSubmit = function (e, c) {
                    _data_1.Customer.save(new _data_1.Customer(_form_1.$form.values())).then(function (id) {
                        location.hash = 'main?id=' + id;
                    });
                };
                this._resolve = Promise.all([
                    spa_1.SPA.getFragment("jinyeosoo/root/register"),
                    spa_1.SPA.getStyle("/dist/jinyeosoo/root/register.css")
                ]).then(function (_a) {
                    var frag = _a[0], style = _a[1];
                    var element = frag.children[0];
                    element.insertBefore(style, element.firstChild);
            ...
            Register.prototype.getParam = function () {
                return {};
            };
            Register.prototype.init = function () {
                return this._resolve;
            };
            Register.prototype.load = function (param, search, ele) {
                ele.appendChild(_form_1.$form.onSubmit(this.onSubmit).reset().element);
            };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13), __webpack_require__(6), __webpack_require__(17), __webpack_require__(14), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, spa_1, html_1, _data_1, events_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var selectAll = html_1.HTML.selectAll;
    var propertyMap = events_1.Events.propertyMap;
    function default_1(init) {
        return /** @class */ (function () {
            function Search() {
                var _this = this;
                this._resolve = Promise.all([
                    spa_1.SPA.getFragment("jinyeosoo/root/search"),
                    spa_1.SPA.getStyle("/dist/jinyeosoo/root/search.css")
                ]).then(function (_a) {
                    var frag = _a[0], style = _a[1];
                    var element = frag.children[0];
                    element.insertBefore(style, element.firstChild);
                    selectAll(element, ['input', 'tbody'], function (e, input, tbody) {
                        var r = /[가-힣a-zA-Z\d]+/, temp;
                        // keyup으로 조회
                        input.addEventListener('keyup', function () {
                            var value = input.value;
                            console.log(value, temp);
                            if (r.test(value) && temp !== value) {
                                _data_1.Customer.search(value).then(function (value) {
                                    tbody.textContent = '';
                                    tbody.innerHTML = value.map(function (v, i) {
            ...
            Search.prototype.load = function (param, search) {
            };
    ...
    function default_1(init) {
        return /** @class */ (function () {
            function Register() {
                var _this = this;
                this._resolve = Promise.all([
                    spa_1.SPA.getFragment("jinyeosoo/root/customers"),
                    spa_1.SPA.getStyle("/dist/jinyeosoo/root/customers.css")
                ]).then(function (_a) {
                    var frag = _a[0], style = _a[1];
                    var element = frag.children[0];
                    element.insertBefore(style, element.firstChild);
                    _this.render = selectAll(element, ['tbody', '!tbody tr'], function (e, tbody, tr) {
                        var outerHTML = compile(tr.outerHTML);
                        propertyMap(tbody, 'click', {
                            move: function (_a) {
                                var id = _a.id;
                                location.hash = 'main?id=' + id;
                        ...
                        return function (customers) {
                            tbody.textContent = '';
                            tbody.innerHTML = customers.map(function (c) { return outerHTML(c); }).join('');
                        };
                    });
                    return element;
                });
            ...
            Register.prototype.load = function (param, search, ele) {
                var _this = this;
                return _data_1.Customer.list().then(function (c) { return _this.render(c); });
            };
            Register.prototype.close = function () {
            };
            return Register;
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(13), __webpack_require__(6), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, spa_1, html_1, events_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var selectAll = html_1.HTML.selectAll;
    var propertyMap = events_1.Events.propertyMap;
    ...
    core_1.$ready(function () {
        selectAll(document.body, ['main', '.menu', '#profile'], function (body, main, menu, profile) {
            var initData = {
                aside: select(profile, '{data-name}')
            }, Modules = {
                customer: __webpack_require__(43).default(initData),
                account: __webpack_require__(44).default(initData),
                gallery: __webpack_require__(45).default(initData),
                main: __webpack_require__(46).default(initData),
                managing: __webpack_require__(47).default(initData),
            }, Roots = {
                intro: __webpack_require__(48).default(initData),
                cal: __webpack_require__(49).default(initData),
                register: __webpack_require__(50).default(initData),
                search: __webpack_require__(51).default(initData),
                customers: __webpack_require__(52).default(initData),
            }, bodyClass = body.classList, mainClass = main.classList, isLoad = false, loading = function () {
                return new Promise(function (o, x) {
                    selectAll(document.getElementById('module-block'), ['.text', '.p-bar'], function (block, text, bar) {
                        ...
                        bar.addEventListener('transitionend', function (e) {
                            ...
                            setTimeout(function () { return block.style.opacity = '0'; }, 700);
                            e.stopPropagation();
                        });
                        setTimeout(function () { return bar.style.width = '100%'; }, 300);
                        setTimeout(function () { return text.textContent = '관리자 모듈 로딩'; }, 2100);
                        setTimeout(function () { return text.textContent = '주요 모듈 생성'; }, 1500);
                    });
                    isLoad = true;
                });
            }, spa = new spa_1.SPA({
            ...
            for (p in Modules)
                spa.register(p, Modules[p]);
            for (p in Roots)
                spa.register(p, Roots[p]);
            spa.onHash();
