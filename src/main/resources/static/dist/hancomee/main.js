    ...
    var List = /** @class */ (function (_super) {
        ...
        List.prototype.$init = function (container, frag, templates) {
            ...
            view[l++] = htmlParser(templates.state, function (c, _a) {
                var li = _a.li;
                return select(frag, function (frag, workState) {
            ...
            view[l++] = htmlParser(templates.work, function (c, _a) {
                var li = _a.li;
                var list = frag.getElementById('list');
                return function (a) {
                    var values = a.values;
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(15), __webpack_require__(26), __webpack_require__(27), __webpack_require__(5), __webpack_require__(28), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, spa_1, list_1, calendar_1, html_1, view_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var select = html_1.HTML.select;
    var _a = Array.prototype, forEach = _a.forEach, map = _a.map, reduce = _a.reduce;
    core_1.$ready(function () {
        select(document.body, function (body, aside, main) {
            var 
            // 페이지
