...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, spa_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Src = /** @class */ (function () {
        function Src(name) {
            ...
            this._resolve = Promise.all([
                spa_1.SPA.getFragment("boosteel/src/" + name),
                spa_1.SPA.getStyle("/dist/boosteel/src/" + name + ".css")
            ]).then(function (_a) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_1() {
        var C = /** @class */ (function (_super) {
            ...
            C.prototype.$init = function (element) {
            };
            C.prototype.load = function (param, search, element) {
            };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(6), __webpack_require__(13), __webpack_require__(7), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, html_1, spa_1, array_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var selectAll = html_1.HTML.selectAll;
    core_1.$ready(function () {
        // ****************************** nav ****************************** //
        var menu = selectAll(document.querySelector('nav'), ['[data-url][]', '#product-toggle', '#products-menu', '.menu', '.menu-close'], function (nav, _urls, toggle, pCon, pMenu, closeBtn) {
            var tc = toggle.classList, pc = pCon.classList, navC = nav.classList, $pMenu = {
                on: function () {
                    tc.add('active');
                    pc.add('on');
                },
            ...
            // 스크롤 위치에 따른 nav 모양
            navStatic = function (y) {
                if (y === 0)
                    navC.add('screen-top');
                else
                    navC.remove('screen-top');
            };
            // 제품 라인 창
            ...
            closeBtn.addEventListener('click', function () { return $pMenu.close(); });
            // 병신같은 ie는 scrollY가 안 먹는다.
            window.addEventListener('scroll', function () { return navStatic(window.pageYOffset); });
            navStatic(window.pageYOffset);
            return {
                active: function (pathname) {
                    array_1._forEach(_urls, function (e) {
        ...
        function $ani(ele, className, remove) {
            if (remove === void 0) { remove = false; }
            if (!ele)
                return _resolve;
            return new Promise(function (o, x) {
                var classList = ele.classList, fn = function () {
                    ...
                    // 로드 된 후에 액션
                    if (remove)
                        classList.remove('load-action');
                    else
                        classList.add('load-action');
                    o();
                };
        ...
        selectAll(document.body, ['main', 'footer'], function (body, main, footer) {
            var bc = body.classList, mc = main.classList, classNames = [
                ...
                onChange: function (ele, e, _a) {
                    var index = _a.index, beforeIndex = _a.beforeIndex, way = _a.way;
                    var c = classNames[way > 0 ? 0 : 1];
                ...
                .register('intro', __webpack_require__(37).default())
                .register('products/cl600', __webpack_require__(55).default())
                .register('products/cl300', __webpack_require__(56).default())
                .onHash();
        });
    });
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1) {
    ...
    function default_1() {
        var C = /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'products/cl600') || this;
            }
            C.prototype.$init = function (element) {
            };
            C.prototype.load = function (param, search, element) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _src_1) {
    ...
    function default_1() {
        var C = /** @class */ (function (_super) {
            __extends(C, _super);
            function C() {
                return _super.call(this, 'products/cl300') || this;
            }
            C.prototype.$init = function (element) {
            };
            C.prototype.load = function (param, search, element) {
