...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, _MediaCodec_1) {
    ...
    var VideoCodec = /** @class */ (function (_super) {
        ...
        function VideoCodec(viewer) {
            return _super.call(this, viewer, r) || this;
        }
        VideoCodec.prototype.create = function (media) {
            var video = document.createElement('video'), source = document.createElement('source'), ele = new _MediaCodec_1.MediaElement(video, media);
            video.onload = function () {
                ele.mediaHeight = video.videoHeight;
                ele.mediaWidth = video.videoWidth;
                video.pause();
                ele.render();
                ele.isLoad = true;
            };
            video.appendChild(source);
            source.src = _MediaCodec_1.MediaElement.src(media);
            return ele;
        };
        return VideoCodec;
    }(_MediaCodec_1.MediaCodec));
    exports.VideoController = VideoCodec;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(14), __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, ImageCodec_1, VideoCodec_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Viewer = /** @class */ (function () {
        function Viewer(element, body) {
            var _this = this;
            this.element = element;
            this.body = body;
            this.events = new events_1.EventsGroup();
            this.codecs = [
                new ImageCodec_1.ImageCodec(this),
                new VideoCodec_1.VideoCodec(this)
            ];
            /*
             *  공통 이벤트
             *  ① 화면 끄기
             ...
             */
            this.events
                .register(events_1.Events.keyDown(element, [27], function () { return _this.close().off(); }))
                .register(element, 'mousewheel', function (e) {
                var list = body.list, index = list.indexOf(_this.active), next = (e['wheelDelta'] < 0 ? 1 : -1) + index;
                if (next > -1 && next < list.length) {
                    _this.close().open(list[next]);
                }
            })
                .register(element, 'click', function (e) {
        ...
        Viewer.prototype.open = function (media) {
        };
