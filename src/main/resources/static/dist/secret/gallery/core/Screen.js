...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1) {
    ...
    var Screen = /** @class */ (function () {
        function Screen(element, body) {
            var _this = this;
            this.element = element;
            this.body = body;
            this.events = new events_1.EventsGroup();
            this.videoEvent = new events_1.EventsGroup();
            this.imageEvent = new events_1.EventsGroup();
            /*
             *  공통 이벤트
             *  ① 화면 끄기
             *  ② 미디어 이동
        ...
        Screen.prototype.close = function () {
            ...
            active && active.appendTo(activeParent);
            this.active = null;
            return this;
        };
        Screen.prototype.open = function (media) {
        };
