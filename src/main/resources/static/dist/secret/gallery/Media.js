...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(7), __webpack_require__(2), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, NameMap_1, arrays_1, core_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(4), __webpack_require__(1), __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, template_1, events_1, dom_1, MediaElement_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var cNames = {
        shot: {
            true: ['!badge-secondary', 'badge-primary'],
            false: ['badge-secondary', '!badge-primary'],
        }
    };
    var Util;
    (function (Util) {
    ...
    var MediaType = /** @class */ (function () {
        function MediaType(data) {
            ...
            $template.id = 'media-' + data.id;
            $template.setAttribute('data-media-id', data.id.toString());
        }
        MediaType.prototype.setRotate = function (v) {
            this.rotate = v;
            return this;
        };
        MediaType.prototype.shotdown = function () {
            this.shot > 0 && this.shot--;
            return this;
        };
        MediaType.prototype.shotup = function () {
            this.shot++;
            return this;
        };
        MediaType.prototype.setFavorite = function (favorite) {
            this.favorite = favorite;
            return this;
        };
        MediaType.prototype.appendTo = function (ele) {
            ele.appendChild(this.$template);
            return this;
        };
        MediaType.prototype.onThumb = function () {
        };
        MediaType.prototype.apply = function () {
            return this;
        };
        MediaType = __decorate([
            template_1.Template({
                galFavorite: function (ele, attrs, obj) {
                    return {
                        favorite: function () {
                            ele.setAttribute('data-favorite', obj.favorite.toString());
                        }
                    };
                },
                galRotate: function (ele, attrs, obj) {
                    var i = ele.firstElementChild;
                    return {
                        rotate: function () {
                            i.setAttribute('style', 'transform: rotate(' + obj.rotate + 'deg)');
                        }
                    };
                },
                galBlind: function (ele, attrs, obj) {
                    var i = ele.firstElementChild;
                    return {
                        blind: function () {
                            dom_1.DOM.className(ele, ['active'], obj.blind);
                            i.textContent = obj.blind ? 'visibility_off' : 'visibility';
                        }
                    };
                },
                galShot: function (ele, attrs, obj) {
                    var firstElementChild = ele.firstElementChild;
                    return {
                        shot: function () {
                            firstElementChild.textContent = obj.shot.toString();
                            dom_1.DOM.className(firstElementChild, cNames.shot[(obj.shot > 0) + '']);
                        }
                    };
                }
            }),
    ...
    var ImageType = /** @class */ (function (_super) {
        ...
        ImageType = __decorate([
            template_1.Template('=#media-template', {
                mediaContent: function (ele, attrs, obj) {
                    var img = new Image(), ev = events_1.Events.bind(img, 'load', function () {
                        img.setAttribute('data-media-action', 'screen');
                        obj.mediaElement = obj.thumbElement = new MediaElement_1.ImageElement(img);
                        ele.appendChild(img);
                        ev.off();
                    });
                    img.src = Util.src(obj);
                    /*return {
                        rotate: () => obj.resize()
                    }*/
                }
     ...
     *  비디오 타입
     */
    var VideoType = /** @class */ (function (_super) {
        __extends(VideoType, _super);
        function VideoType() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
    ...
    (function (MediaType) {
        function create(v) {
            return v.filetype === 'mp4' ? new VideoType(v) : new ImageType(v);
        }
        MediaType.create = create;
